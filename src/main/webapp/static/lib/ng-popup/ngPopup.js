    ...
    function NgPopupBuilder($q, $http,$log){
        ...
        function __layoutInitAsync(option){
            var templateHtml = (option.template) ? option.template : ''
                ,deferred = $q.defer()
                ,html = '<div class="container" convId="{{option.conversationKey}}" data-ng-controller="ChatMessengerController">' +
                ...
                '<div class="iconGroup">' +
                '<i class="fa fa-plus" ng-click="addMorFriends()" ' +
                    'data-toggle="tooltip" title="Add more friends to chat" id="minBtn"></i>' +
